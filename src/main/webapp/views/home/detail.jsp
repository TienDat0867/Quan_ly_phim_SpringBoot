...
<body id="#top">
  ...
  <main>
      ...
      <section class="movie-detail">
        <div class="container">
          ...
          <div class="movie-detail-content">
            ...
            <c:forEach var="daodien" items="${phim.daodien}">
            		<a href="#">${daodien.tendaodien}</a>
            </c:forEach>
              </div>
			
              <div class="date-time">
			<div>
			<c:forEach items="${phim.loaiphim}" var="loaiphim">
					<div>${loaiphim.tenloaiphim}  </div>
			</c:forEach>
			</div>  
                <div>
                  <ion-icon name="calendar-outline"></ion-icon>

                  <time datetime="2021">${phim.ngaysanxuat}</time>
                </div>

                <div>
                  <ion-icon name="time-outline"></ion-icon>
                  <time datetime="PT115M">${phim.thoiluong} min</time>
                </div>
			<a href="/home/bookSeat" class="btn btn-primary">Đặt Vé</a> 
              </div>
	...
	<iframe width="660" height="415" style="padding-left:120px; " src="https://www.youtube.com/embed/${phim.href}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
